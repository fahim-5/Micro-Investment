...
const Navbar = () => {
  ...
  const navigation = [
    ...
    { name: "Wallet", href: "/wallet", icon: <MdAccountBalanceWallet /> },
  ];
  ...
  // DSE Market Data
  const marketData = {
    dsex: { value: "6,342.12", change: "+0.75%", isUp: true },
    dses: { value: "1,456.34", change: "+0.32%", isUp: true },
  };
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-1 sm:space-y-0 text-sm">
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                ...
                <span
                  className={`font-bold ${marketData.dsex.isUp ? "text-green-400" : "text-red-400"}`}
                >
                  {marketData.dsex.value}
                </span>
                <span
                  className={`text-xs px-1.5 py-0.5 rounded ${marketData.dsex.isUp ? "bg-green-900/30 text-green-300" : "bg-red-900/30 text-red-300"}`}
                >
              ...
              <div className="flex items-center space-x-2">
                ...
                <span
                  className={`font-bold ${marketData.dses.isUp ? "text-green-400" : "text-red-400"}`}
                >
                  {marketData.dses.value}
                </span>
                <span
                  className={`text-xs px-1.5 py-0.5 rounded ${marketData.dses.isUp ? "bg-green-900/30 text-green-300" : "bg-red-900/30 text-red-300"}`}
                >
            ...
            <div className="text-xs text-gray-400">
              Start from BDT 100 • Zero commission
            </div>
          </div>
        </div>
      </div>
